...
conn.on('ready', () => {
    ...
    const sql = `
        ALTER TABLE public.attendance DROP CONSTRAINT IF EXISTS "attendance_student_id_cohort_id_date_key" CASCADE;
    ...
    `;
    // We execute the commands one by one to ensure we capture the results.
