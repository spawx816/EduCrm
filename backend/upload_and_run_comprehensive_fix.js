...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const localFile = 'd:/EduC/apps/backend/fix_exams_comprehensive.sql';
        const remoteFile = '/tmp/fix_exams_comprehensive.sql';
        ...
        sftp.fastPut(localFile, remoteFile, {}, (uploadErr) => {
            ...
            // Execute with sudo
            const cmd = `echo "Arrd1227" | sudo -S -u postgres psql -d educrm -f /tmp/fix_exams_comprehensive.sql`;
